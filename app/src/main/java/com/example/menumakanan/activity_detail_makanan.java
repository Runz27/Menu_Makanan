...
public class activity_detail_makanan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgcall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ActivityCompat.checkSelfPermission(activity_detail_makanan.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
